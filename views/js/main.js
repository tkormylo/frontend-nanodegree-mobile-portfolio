...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    for (var i = 0; i < numOfPizzaContainers; i++) {
      ranPizzaContainers[i].style.width = newwidth;
    }
  }
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  for (var i = 0; i < 35; i++) { // Change number of little pizzas from 200 to 35.
                    // The lower the number, the better the FPS. According to the forums, 35 is the minimum to be used.
